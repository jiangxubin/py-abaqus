...
max_horizon_limit = 45
mid_horizon_limit = 0.0
min_horizon_limit = -45
...
mdb.models['Model-1'].sketches['__profile__'].Spot(point=(crack_horizon_limit, crack_vertical_limit))
mdb.models['Model-1'].sketches['__profile__'].Line(point1=(crack_horizon_limit, crack_vertical_limit), point2=(
    crack_horizon_limit, 0.0))
...
mdb.models['Model-1'].SoilsStep(cetol=None, initialInc=0.05, matrixSolver=
    ...
    'injection', previous='pore-balance', timePeriod=200.0, utol=1e09)
...
mdb.models['Model-1'].TabularAmplitude(data=((0.0, 0.0), (50.0, -200.0),(100,-250) ), name=
...
# o3 = session.openOdb(
#     name='D:/thesis/mini-thesis/centrifuge/Centrifuge-2018-11-29-21-27.odb')
