...
class Graph:
    ...
    def even_odd_merge_pair(x: list, y: list):
        ...
        # odd_X = pd.Series(odd_X)
        odd_Y = [item[1] for item in odd_res]
        # odd_Y = pd.Series(odd_Y)
        return odd_X, odd_Y
...
if __name__ == "__main__":
    ...
    # Z_0 = pd.DataFrame({"X":X_0, "Y":Y_0})
    # Z_0.to_csv(r"..\data\origin\0.csv", header=None, index=None, sep="\t")
    # X_1, Y_1 = Graph.remove_duplicate_merge_pair(X_1, Y_1)
    # Z_1 = pd.DataFrame({"X":X_1, "Y":Y_1})
    # Z_1.to_csv(r"..\data\origin\1.csv",header=None, index=None, sep="\t")
    # X_2, Y_2 = Graph.remove_duplicate_merge_pair(X_2, Y_2)
    # Z_2 = pd.DataFrame({"X":X_2, "Y":Y_2})
    # Z_2.to_csv(r"..\data\origin\2.csv",header=None, index=None, sep="\t")
    # X_3, Y_3 = Graph.remove_duplicate_merge_pair(X_3, Y_3)
    # Z_3 = pd.DataFrame({"X":X_3, "Y":Y_3})
    # Z_3.to_csv(r"..\data\origin\3.csv",header=None, index=None, sep="\t")
    ...
    # Z_0 = pd.DataFrame({"X":X_0, "Y":Y_0})
    # Z_0.to_csv(r"..\data\origin\4.csv", header=None, index=None, sep="\t")
    # Z_1 = pd.DataFrame({"X":X_1, "Y":Y_1})
    # Z_1.to_csv(r"..\data\origin\5.csv",header=None, index=None, sep="\t")
    # Z_2 = pd.DataFrame({"X":X_2, "Y":Y_2})
    # Z_2.to_csv(r"..\data\origin\6.csv",header=None, index=None, sep="\t")
    # Z_3 = pd.DataFrame({"X":X_3, "Y":Y_3})
    # Z_3.to_csv(r"..\data\origin\7.csv",header=None, index=None, sep="\t")
    ...
    # Z_0 = pd.DataFrame({"X":X_0, "Y":Y_0})
    # Z_0.to_csv(r"..\data\origin\8.csv", header=None, index=None, sep="\t")
    # Z_1 = pd.DataFrame({"X":X_1, "Y":Y_1})
    # Z_1.to_csv(r"..\data\origin\9.csv",header=None, index=None, sep="\t")
    # Z_4 = pd.DataFrame({"X":X_4, "Y":Y_4})
    # Z_4.to_csv(r"..\data\origin\10.csv",header=None, index=None, sep="\t")
    # # plot_comparision([X_0, X_1, X_2, X_3, X_4], [Y_0, Y_1, Y_2, Y_3, Y_4], tabel_title="Effects of permeability on pore pressure", tabel_legend=["Even Permeability:2e-5", "Even Permeability:2e-7", "Even Permeability:2e-9", "Even Permeability:2e-11", "Even Permeability:2e-4"])
    ...
    # Z_0 = pd.DataFrame({"X":X_0, "Y":Y_0})
    # Z_0.to_csv(r"..\data\origin\11.csv", header=None, index=None, sep="\t")
    # Z_1 = pd.DataFrame({"X":X_1, "Y":Y_1})
    # Z_1.to_csv(r"..\data\origin\12.csv",header=None, index=None, sep="\t")
    # Z_4 = pd.DataFrame({"X":X_4, "Y":Y_4})
    # Z_4.to_csv(r"..\data\origin\13.csv",header=None, index=None, sep="\t")
    ...
    # X_4, Y_4 =  Graph.remove_duplicate_merge_pair(X_4, Y_4)
    # Z_0 = pd.DataFrame({"X":X_0, "Y":Y_0})
    # Z_0.to_csv(r"..\data\origin\14.csv", header=None, index=None, sep="\t")
    # Z_1 = pd.DataFrame({"X":X_1, "Y":Y_1})
    # Z_1.to_csv(r"..\data\origin\15.csv",header=None, index=None, sep="\t")
    # Z_4 = pd.DataFrame({"X":X_4, "Y":Y_4})
    # Z_4.to_csv(r"..\data\origin\16.csv",header=None, index=None, sep="\t")
    ...
    X_4, Y_4 = Graph.even_odd_merge_pair(X_4, Y_4)
    Z_0 = pd.DataFrame({"X":X_0, "Y":Y_0})
    Z_0.to_csv(r"..\data\origin\17.csv", header=None, index=None, sep="\t")
    Z_1 = pd.DataFrame({"X":X_1, "Y":Y_1})
    Z_1.to_csv(r"..\data\origin\18.csv",header=None, index=None, sep="\t")
    Z_4 = pd.DataFrame({"X":X_4, "Y":Y_4})
    Z_4.to_csv(r"..\data\origin\19.csv",header=None, index=None, sep="\t")
    # # plot_comparision([X_0, X_1, X_2, X_3, X_4], [Y_0, Y_1, Y_2, Y_3, Y_4], tabel_title="Effects of permeability on pore pressure", tabel_legend=["Even Permeability:2e-5", "Even Permeability:2e-7", "Even Permeability:2e-9", "Even Permeability:2e-11", "Even Permeability:2e-4"])
