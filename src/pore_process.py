...
def plot_data(x, y, x_name, y_name, grapth_type):
    '''
    Plot the data
    :param x: x axis
    :param y: y axis
    ...
    fig, ax = plt.subplots()
    graph_df = pd.DataFrame({x_name: x, y_name: y})
    graph_df.plot(kind=grapth_type, x=x_name, y=y_name, ax=ax)
    plt.show()
...
def plot_comparision_open_size(x, y, tabel_title="Comaprision", tabel_legend=["Tabel Legend: Legend"]):
    ...
    # ax.set_ylabel("裂纹开口尺寸(mm)",  fontproperties=myfont)
...
def plot_comparision_pore_pressure(x, y, tabel_title="Comaprision", tabel_legend=["Tabel Legend: Legend"]):
    ...
    ax.set_xlabel("时间(s)", fontproperties=myfont)
    ax.set_ylabel("孔压(Pa)", fontproperties=myfont)
    ax.set_ylim(bottom=0)
    # ax.set_title(tabel_title, fontproperties=myfont)
    # ax.set_title(tabel_title)
    ax.legend(loc='upper right', shadow=True, prop=myfont)
    ax.set_xlim(right=100)
    # ax.set_ylim(top=900000)
    ax.spines['top'].set_visible(False)
    ax.spines['right'].set_visible(False)
    plt.show()
...
if __name__ == "__main__":
    X_0 = read_data(r"D:\论文产出\小论文\py_thesis\data\base\middle_crack_size_time.csv")
    Y_0 = read_data(r"D:\论文产出\小论文\py_thesis\data\base\middle_crack_size_size.csv")
    X_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_size_time_0.csv")
    Y_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_size_size_0.csv")
    X_2 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_size_time_1.csv")
    Y_2 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_size_size_1.csv")
    X_3 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_size_time_2.csv")
    Y_3 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_size_size_2.csv")
    ...
    plot_comparision_open_size([X_1, X_2, X_3], [Y_1, Y_2, Y_3], tabel_title="孔隙率对裂纹开口尺寸的影响", tabel_legend=["孔隙率:0.5", "孔隙率:0.2", "孔隙率: 0.01"])
    ...
    # X_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_pre_time_0.csv")
    # Y_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_pre_pre_0.csv")
    # X_1, Y_1 = even_odd_merge_pair(X_1, Y_1)
    # X_2 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_pre_time_1.csv")
    # Y_2 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_pre_pre_1.csv")
    # X_2, Y_2 = even_odd_merge_pair(X_2, Y_2)
    # X_3 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_pre_time_2.csv")
    # Y_3 = read_data(r"D:\论文产出\小论文\py_thesis\data\poros\middle_crack_pre_pre_2.csv")
    ...
    # plot_comparision_pore_pressure([X_1, X_2, X_3], [Y_1, Y_2, Y_3], tabel_title="孔隙率对裂纹内孔压的影响", tabel_legend=["孔隙率:0.01", "孔隙率:0.2", "孔隙率:0.5"])
    #
    # X_0 = read_data(r"D:\论文产出\小论文\py_thesis\data\base\middle_crack_pre_time.csv")
    # Y_0 = read_data(r"D:\论文产出\小论文\py_thesis\data\base\middle_crack_pre_pre.csv")
    # X_0, Y_0 = even_odd_merge_pair(X_0, Y_0)
    # X_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\permeability\middle_crack_pre_time_1.csv")
    # Y_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\permeability\middle_crack_pre_pre_1.csv")
    # X_1, Y_1 = even_odd_merge_pair(X_1, Y_1)
    ...
    # plot_comparision_pore_pressure([X_4, X_0, X_1], [Y_4, Y_0, Y_1], tabel_title="渗透系数对裂纹内孔压影响", tabel_legend=["渗透系数:2e-4", "渗透系数:2e-5", "渗透系数:2e-7"])

    # X_0 = read_data(r"D:\论文产出\小论文\py_thesis\data\base\middle_crack_size_time.csv")
    # Y_0 = read_data(r"D:\论文产出\小论文\py_thesis\data\base\middle_crack_size_size.csv")
    # X_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\permeability\middle_crack_size_time_1.csv")
    # Y_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\permeability\middle_crack_size_size_1.csv")
    # X_2 = read_data(r"D:\论文产出\小论文\py_thesis\data\permeability\middle_crack_size_time_2.csv")
    # Y_2 = read_data(r"D:\论文产出\小论文\py_thesis\data\permeability\middle_crack_size_size_2.csv")
    # X_3 = read_data(r"D:\论文产出\小论文\py_thesis\data\permeability\middle_crack_size_time_3.csv")
    # Y_3 = read_data(r"D:\论文产出\小论文\py_thesis\data\permeability\middle_crack_size_size_3.csv")
    # X_4 = read_data(r"D:\论文产出\小论文\py_thesis\data\permeability\middle_crack_size_time_4.csv")
    # Y_4 = read_data(r"D:\论文产出\小论文\py_thesis\data\permeability\middle_crack_size_size_4.csv")
    # X_0, Y_0 = remove_duplicate_merge_pair(X_0, Y_0)
    # X_1, Y_1 = remove_duplicate_merge_pair(X_1, Y_1)
    # X_2, Y_2 = remove_duplicate_merge_pair(X_2, Y_2)
    # X_3, Y_3 = remove_duplicate_merge_pair(X_3, Y_3)
    # X_4, Y_4 = remove_duplicate_merge_pair(X_4, Y_4)
    # plot_comparision_open_size([X_4, X_0, X_1], [Y_4, Y_0, Y_1], tabel_title="渗透系数对裂纹开口尺寸的影响", tabel_legend=["渗透系数:2e-4", "渗透系数:2e-5", "渗透系数:2e-7"])
    ...
    # Y_0 = read_data(r"D:\论文产出\小论文\py_thesis\data\base\middle_crack_size_size.csv")
    # X_0, Y_0 = remove_duplicate_merge_pair(X_0, Y_0)
    # X_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_size_time_1.csv")
    # Y_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_size_size_1.csv")
    # X_1, Y_1 = remove_duplicate_merge_pair(X_1, Y_1)
    # X_2 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_size_time_2.csv")
    # Y_2 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_size_size_2.csv")
    # X_2, Y_2 = remove_duplicate_merge_pair(X_2, Y_2)
    # X_3 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_size_time_3.csv")
    # Y_3 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_size_size_3.csv")
    # X_3, Y_3 = remove_duplicate_merge_pair(X_3, Y_3)
    # X_4 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_size_time_4.csv")
    # Y_4 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_size_size_4.csv")
    # X_4, Y_4 = remove_duplicate_merge_pair(X_4, Y_4)
    ...
    # plot_comparision_open_size([X_1, X_0, X_4], [Y_1, Y_0, Y_4], tabel_title="流体粘度对裂纹开口尺寸的影响", tabel_legend=["流体粘度:e-12","流体粘度:e-16",  "流体粘度:e-20"])

    # X_0 = read_data(r"D:\论文产出\小论文\py_thesis\data\base\middle_crack_pre_time.csv")
    # Y_0 = read_data(r"D:\论文产出\小论文\py_thesis\data\base\middle_crack_pre_pre.csv")
    # X_0, Y_0 = even_odd_merge_pair(X_0, Y_0)
    # X_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_pre_time_1.csv")
    # Y_1 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_pre_pre_1.csv")
    # X_1, Y_1 = even_odd_merge_pair(X_1, Y_1)
    # X_2 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_pre_time_2.csv")
    # Y_2 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_pre_pre_2.csv")
    # X_2, Y_2 = even_odd_merge_pair(X_2, Y_2)
    # X_3 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_pre_time_3.csv")
    # Y_3 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_pre_pre_3.csv")
    # X_3, Y_3 = even_odd_merge_pair(X_3, Y_3)
    # X_4 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_pre_time_4.csv")
    # Y_4 = read_data(r"D:\论文产出\小论文\py_thesis\data\viscosity\middle_crack_pre_pre_4.csv")
    # X_4, Y_4 = even_odd_merge_pair(X_4, Y_4)
    # # plot_comparision([X_0, X_1, X_2, X_3, X_4], [Y_0, Y_1, Y_2, Y_3, Y_4], tabel_title="Effects of permeability on pore pressure", tabel_legend=["Even Permeability:2e-5", "Even Permeability:2e-7", "Even Permeability:2e-9", "Even Permeability:2e-11", "Even Permeability:2e-4"])
    ...
    # plot_comparision_pore_pressure([X_1, X_0,  X_4], [Y_1, Y_0,  Y_4], tabel_title="流体粘度对裂纹内孔压的影响", tabel_legend=["流体粘度:e-12", "流体粘度:e-16",   "流体粘度:e-20"])
