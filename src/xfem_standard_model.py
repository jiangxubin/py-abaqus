...
mdb.models['Model-1'].sketches['__profile__'].Spot(point=(15.5, 31.0))
mdb.models['Model-1'].sketches['__profile__'].Spot(point=(-15.5, 0.0))
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(-15.5, 0.0), 
    point2=(15.5, 31.0))
...
mdb.models['Model-1'].parts['soil'].Set(edges=
    mdb.models['Model-1'].parts['soil'].edges.findAt(((-15.5, 7.75, 0.0), )), 
    name='left')
mdb.models['Model-1'].parts['soil'].Set(edges=
    mdb.models['Model-1'].parts['soil'].edges.findAt(((15.5, 23.25, 0.0), )), 
    name='right')
mdb.models['Model-1'].parts['soil'].Set(edges=
    mdb.models['Model-1'].parts['soil'].edges.findAt(((7.75, 0.0, 0.0), )), 
    name='bottom')
mdb.models['Model-1'].ConstrainedSketch(name='__profile__', sheetSize=200.0)
mdb.models['Model-1'].sketches['__profile__'].Spot(point=(0.0, 0.0))
mdb.models['Model-1'].sketches['__profile__'].Spot(point=(0.0, 1.0))
...
mdb.models['Model-1'].materials['soil'].Permeability(inertialDragCoefficient=
    0.142887, specificWeight=10000.0, table=((2.618e-06, 0), ))
...
mdb.models['Model-1'].PorePressureBC(amplitude=UNSET, createStepName='geo', 
    distributionType=UNIFORM, fieldName='', fixed=OFF, magnitude=310000.0, 
    name='bottom-pore', region=
    mdb.models['Model-1'].rootAssembly.instances['soil-1'].sets['bottom'])
mdb.models['Model-1'].GeostaticStress(lateralCoeff1=0.6, lateralCoeff2=None, 
    name='geo', region=
    mdb.models['Model-1'].rootAssembly.instances['soil-1'].sets['soil'], 
    stressMag1=0.0, stressMag2=-310000.0, vCoord1=31.0, vCoord2=0.0)
...
mdb.models['Model-1'].steps['geo'].setValues(timeIncrementationMethod=FIXED, 
    utol=None)
mdb.models['Model-1'].predefinedFields['geo'].resume()
...
# Save by augustus on 2019_03_04-21.53.35; build 2016 2015_09_25-04.31.09 126547
