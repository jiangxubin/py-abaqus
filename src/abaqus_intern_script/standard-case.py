...
mdb.models['Model-1'].predefinedFields['pore'].suppress()
mdb.models['Model-1'].predefinedFields['geo'].suppress()
mdb.models['Model-1'].predefinedFields['pore'].resume()
mdb.jobs['Job-test'].submit(consistencyChecking=OFF)
