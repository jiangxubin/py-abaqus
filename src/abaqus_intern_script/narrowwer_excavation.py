...
if __name__ == "__main__":
    ...
    parameter_2['max_excavation_horizon_limit'] = 7.5
    parameter_2['min_execavation_horizon_limit'] = -7.5
    parameter_2['crack_horizon_limit_bottom'] = 9.0
    parameter_2['crack_horizon_limit_mid'] = 9.0
    parameter_2['crack_horizon_limit_top'] = 9.0
    ...
    parameter_2['crack_node_left'] = 172
    parameter_2['crack_node_right'] = 173
