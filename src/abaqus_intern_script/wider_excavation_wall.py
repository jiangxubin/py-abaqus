...
if __name__ == "__main__":
    parameter_2 = dict()
    parameter_2['max_horizon_limit'] = 40.5
    parameter_2['mid_horizon_limit'] = 0.0
    parameter_2['min_horizon_limit'] = -40.5
    ...
    parameter_2['poson'] = 0.17
    parameter_2['amp'] = ((0.0, 0.0), (50, -200), (100, -250))
    parameter_2['max_excavation_horizon_limit'] = 18
    parameter_2['min_excavation_horizon_limit'] = -18
    parameter_2['crack_horizon_limit_bottom'] = 16.5
    parameter_2['crack_horizon_limit_mid'] = 16.5
    parameter_2['crack_horizon_limit_top'] = 16.5
    ...
    parameter_2['crack_node_left'] = 190
    parameter_2['crack_node_right'] = 191
