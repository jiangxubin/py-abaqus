...
root_path = "D:\\thesis\\mini-thesis\\centrifuge_wall\\"
...
def pre_process(parameter):
    ...
    mdb.models['Model-1'].TabularAmplitude(data=parameter['amp_1'], name=
        'volumerate_1', smooth=SOLVER_DEFAULT, timeSpan=STEP)
...
if __name__ == "__main__":
    ...
    parameter_2['amp_1'] = ((0.0, -250), (25, -275), (50, -300))
    parameter_2['max_excavation_horizon_limit'] = 6.5
    parameter_2['min_execavation_horizon_limit'] = -6.5
    parameter_2['crack_horizon_limit_bottom'] = 8.0
    parameter_2['crack_horizon_limit_mid'] = 8.0
    parameter_2['crack_horizon_limit_top'] = 8.0
    ...
    parameter_2['crack_node_left'] = 168
    parameter_2['crack_node_right'] = 169
